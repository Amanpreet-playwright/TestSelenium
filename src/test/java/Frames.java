...
public class Frames {
	...
	public static void main(String[] args) {
		...
		System.out.println(driver.findElement(By.xpath("//h1[@id='sampleHeading'][1]")).getText().toString());
		driver.switchTo().defaultContent();
		WebElement Ele=driver.findElement(By.id("frame2"));
		driver.switchTo().frame(Ele);
		//System.out.println(driver.findElement(By.xpath("//h1[@id='sampleHeading'][2]")).getText().toString());
         js.executeScript("window.scrollBy(0,250)", "");
